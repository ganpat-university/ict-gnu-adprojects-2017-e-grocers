<?php
	...
	if($password==$conf_password && $user_name!=null && $first_name!=null && $last_name!=null && $phone!=null && $address!=null)
	{	
	
	$query="Insert into grocer values ('$user_name','$first_name','$last_name','$address','$phone','$password','$conf_password')";
...
<html>
	...
	<body>
			...
			<div class="signup">
				...
				<br>
				<br>
				 <h1 align="center"> grocer_signup</h1>
